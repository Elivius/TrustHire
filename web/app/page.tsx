...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-bg-base text-foreground flex flex-col selection:bg-[#7B61FF]/30 selection:text-white transition-colors duration-200">
      {/* Navigation */}
        ...
        <div className="flex h-16 items-center justify-between px-4 sm:px-6 max-w-7xl mx-auto">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="text-lg font-bold tracking-tight text-foreground flex items-center gap-1.5">
              TrustHire
              <span className="text-[10px] uppercase font-mono px-1.5 py-0.5 rounded bg-[#2DD4BF]/10 text-[#0D9488] dark:text-[#2DD4BF] border border-[#2DD4BF]/20 font-medium">
                Prototype
              </span>
            </span>
          </Link>
      ...
      <section className="relative pt-20 pb-16 md:pt-28 md:pb-24 px-4 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-gradient-to-tr from-[#4DA2FF]/15 via-[#7B61FF]/15 to-[#2DD4BF]/15 dark:from-[#4DA2FF]/20 dark:via-[#7B61FF]/20 dark:to-[#2DD4BF]/20 blur-[120px] rounded-full pointer-events-none" />

        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-[#8B5CF6]/30 bg-[#8B5CF6]/10 text-xs font-medium text-[#7C3AED] dark:text-[#A78BFA] backdrop-blur-md">
          ...
          <p className="text-base sm:text-lg md:text-xl text-foreground/75 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto mt-16 p-4 sm:p-6 rounded-2xl border border-black/[0.08] dark:border-white/10 bg-white/90 dark:bg-[#151622]/80 backdrop-blur-xl grid grid-cols-1 sm:grid-cols-3 gap-6 text-center divide-y sm:divide-y-0 sm:divide-x divide-black/[0.08] dark:divide-white/10 shadow-lg dark:shadow-2xl">
          <div className="space-y-1 sm:px-4">
            <div className="text-xl sm:text-2xl font-bold text-[#0D9488] dark:text-[#2DD4BF] font-mono">100% On-Chain</div>
            <div className="text-xs text-foreground/60">Escrow contracts secured on Sui</div>
          </div>
          <div className="space-y-1 sm:px-4 pt-4 sm:pt-0">
            <div className="text-xl sm:text-2xl font-bold text-[#7C3AED] dark:text-[#A78BFA] font-mono">Gonka Router AI</div>
            <div className="text-xs text-foreground/60">Autonomous skill & trust verification</div>
          </div>
          <div className="space-y-1 sm:px-4 pt-4 sm:pt-0">
            <div className="text-xl sm:text-2xl font-bold text-foreground font-mono">$0 Custody Risk</div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20 px-4 max-w-7xl mx-auto w-full border-t border-black/[0.05] dark:border-white/5">
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          <span className="text-xs font-mono font-semibold uppercase tracking-wider text-[#2563EB] dark:text-[#4DA2FF]">
          ...
          {[
            {
              ...
              icon: Cpu,
              color: "text-[#2563EB] dark:text-[#4DA2FF]"
            },
            {
              step: "02",
            ...
            return (
              <div
                key={card.step}
                className="relative rounded-2xl border border-black/[0.08] dark:border-white/10 bg-white/80 dark:bg-[#151622]/60 p-6 backdrop-blur-md hover:border-black/20 dark:hover:border-white/20 transition-all shadow-sm dark:shadow-none group"
              >
                <div className="flex items-center justify-between mb-4">
                  <div className={`p-2.5 rounded-xl bg-black/[0.03] dark:bg-white/5 ${card.color}`}>
                    <Icon className="w-5 h-5" />
                  </div>
                  <span className="font-mono text-xs font-bold text-foreground/40 group-hover:text-foreground/70 transition-colors">
                    {card.step}
                  </span>
                </div>
                <h3 className="text-base font-semibold text-foreground mb-2">{card.title}</h3>
                <p className="text-xs text-foreground/70 leading-relaxed">{card.desc}</p>
              </div>
            );
          })}
        </div>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* For Clients */}
          <div id="for-clients" className="rounded-3xl border border-[#4DA2FF]/30 dark:border-[#4DA2FF]/20 bg-gradient-to-br from-white to-blue-50/50 dark:from-[#151622] dark:to-[#151622]/50 p-8 sm:p-10 space-y-6 relative overflow-hidden shadow-sm dark:shadow-none">
            <div className="space-y-2">
              <span className="text-xs font-mono uppercase tracking-wider text-[#2563EB] dark:text-[#4DA2FF] font-semibold">For Clients & DAOs</span>
              <h3 className="text-2xl sm:text-3xl font-bold text-foreground">Hire verified Web3 talent in minutes</h3>
          ...
          {/* For Freelancers */}
          <div id="for-freelancers" className="rounded-3xl border border-[#7B61FF]/30 dark:border-[#7B61FF]/20 bg-gradient-to-br from-white to-purple-50/50 dark:from-[#151622] dark:to-[#151622]/50 p-8 sm:p-10 space-y-6 relative overflow-hidden shadow-sm dark:shadow-none">
            <div className="space-y-2">
              <span className="text-xs font-mono uppercase tracking-wider text-[#7C3AED] dark:text-[#A78BFA] font-semibold">For Freelancers & Devs</span>
              <h3 className="text-2xl sm:text-3xl font-bold text-foreground">Get matched & get paid with certainty</h3>
              <p className="text-xs sm:text-sm text-foreground/70 leading-relaxed">
      ...
      {/* Feature Strip */}
      <section id="features" className="py-16 px-4 border-t border-black/[0.05] dark:border-white/5 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {[
            ...
            const Icon = f.icon;
            return (
              <div key={f.label} className="p-4 rounded-xl border border-black/[0.05] dark:border-white/5 bg-black/[0.02] dark:bg-white/[0.02] text-center space-y-1.5">
                <Icon className="w-5 h-5 mx-auto text-[#2563EB] dark:text-[#4DA2FF]" />
                <div className="font-semibold text-xs text-foreground">{f.label}</div>
      ...
      {/* Footer */}
      <footer className="mt-auto border-t border-black/[0.08] dark:border-white/10 bg-white/70 dark:bg-[#0B0B12] py-8 px-4 transition-colors">
