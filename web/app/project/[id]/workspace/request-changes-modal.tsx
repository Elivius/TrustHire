  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg rounded-3xl border border-white/10 bg-[#151622] p-6 sm:p-8 shadow-2xl space-y-5">
        <div>
          <h3 className="text-xl font-bold text-white">Request Changes on {milestone.title}</h3>
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            className="w-full p-3.5 rounded-xl border border-white/10 bg-white/[0.03] text-xs text-white focus:outline-none focus:border-[#F59E0B] resize-none leading-relaxed"
          />
        </div>
