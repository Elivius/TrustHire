      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <GlassCard className="p-5">
            ...
            <span className="text-[11px] text-[#F59E0B]/80 mt-1 block">Locked for active milestones (not yet released)</span>
          </GlassCard>
        ...
        <div className="space-y-4 pt-2">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <h2 className="text-lg font-bold text-white flex items-center gap-2">
              <Coins className="w-4 h-4 text-[#2DD4BF]" />
            ...
            {myProjects.length > 1 && (
              ...
              >
                <option value="all" className="bg-[#151622]">All Contracts</option>
                {myProjects.map((p) => (
                ...
                <GlassCard key={tx.id} className="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-mono">
                  <div className="space-y-1 font-sans">
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="font-semibold text-sm sm:text-base text-white">{tx.milestoneTitle || tx.projectTitle}</h4>
                  ...
                  <div className="flex items-center gap-6 text-xs">
                    <div className="text-right sm:text-left">
                      ...
                      <span className="text-[#2DD4BF] font-bold text-sm sm:text-base">${tx.amount.toLocaleString()} USDC</span>
                    </div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1.5 rounded-xl bg-white/[0.04] border border-white/10 text-xs text-[#4DA2FF] hover:text-[#7B61FF] transition-colors"
                    >
